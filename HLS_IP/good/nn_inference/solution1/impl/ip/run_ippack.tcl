...
set solution_dir "/home/vincent/Embedded-System/turbo-train-EMB2/HLS_IP/good/nn_inference/solution1"
set debug_dir "/home/vincent/Embedded-System/turbo-train-EMB2/HLS_IP/good/nn_inference/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {nn_inference_fmul_32ns_32ns_32_4_max_dsp_1
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 input_img_1 W 0x0 "Data signal of input_img" {{0 32 input_img W 0 "Bit 31 to 0 of input_img"}}} {0x14 input_img_2 W 0x0 "Data signal of input_img" {{0 32 input_img W 0 "Bit 63 to 32 of input_img"}}} {0x1c output_bus_1 W 0x0 "Data signal of output_bus" {{0 32 output_bus W 0 "Bit 31 to 0 of output_bus"}}} {0x20 output_bus_2 W 0x0 "Data signal of output_bus" {{0 32 output_bus W 0 "Bit 63 to 32 of output_bus"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_control m_axi_AXI_DATA"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_AXI_DATA {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_AXI_DATA"
        data_width "32"
        param_prefix "C_M_AXI_AXI_DATA"
...
## System Info
set user_parameters_list {clk_period 10 machine 64 combinational 0 latency 4576 II x}
