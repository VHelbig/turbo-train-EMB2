...
void hwmm_layer1(volatile uint8_t input[n_inputs], const float weights[n_inputs][n_layer1], float output[1][n_layer1]) {
...
/* Connect NN Layers */
void nn_inference(volatile uint8_t input_img[n_inputs],volatile uint8_t output_bus[1],volatile uint8_t *out_wire){
