...
// wrapc file define:
#define AUTOTB_TVIN_AXI_DATA "../tv/cdatafile/c.image_processing.autotvin_AXI_DATA.dat"
#define AUTOTB_TVOUT_AXI_DATA "../tv/cdatafile/c.image_processing.autotvout_AXI_DATA.dat"
// wrapc file define:
#define AUTOTB_TVIN_in "../tv/cdatafile/c.image_processing.autotvin_in_r.dat"
#define AUTOTB_TVOUT_in "../tv/cdatafile/c.image_processing.autotvout_in_r.dat"
// wrapc file define:
#define AUTOTB_TVIN_out "../tv/cdatafile/c.image_processing.autotvin_out_r.dat"
#define AUTOTB_TVOUT_out "../tv/cdatafile/c.image_processing.autotvout_out_r.dat"

#define INTER_TCL "../tv/cdatafile/ref.tcl"

// tvout file define:
#define AUTOTB_TVOUT_PC_AXI_DATA "../tv/rtldatafile/rtl.image_processing.autotvout_AXI_DATA.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_in "../tv/rtldatafile/rtl.image_processing.autotvout_in_r.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_out "../tv/rtldatafile/rtl.image_processing.autotvout_out_r.dat"
...
extern "C" void image_processing_hw_stub_wrapper(volatile void *, volatile void *);
    ...
    string AESL_num;{
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<32> > AXI_DATA_pc_buffer(6000);
          int i = 0;
          ...
          if (i > 0) {{
            ...
            ((int*)__xlx_apatb_param_in)[j] = AXI_DATA_pc_buffer[i].to_int64();
          }
            for (int j = 0, e = 3000; j < e; j += 1, ++i) {
            ((int*)__xlx_apatb_param_out)[j] = AXI_DATA_pc_buffer[i].to_int64();
          }}}
        } // end transaction
      } // end file is good
...
sc_bv<32> __xlx_tmp_lv = ((int*)__xlx_apatb_param_in)[j];
  ...
  __xlx_offset_byte_param_out = 3000*4;
...
sc_bv<32> __xlx_tmp_lv = ((int*)__xlx_apatb_param_out)[j];
  ...
  tcl_file.set_num(6000, &tcl_file.AXI_DATA_depth);
...
image_processing_hw_stub_wrapper(__xlx_apatb_param_in, __xlx_apatb_param_out);
