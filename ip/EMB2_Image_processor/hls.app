<project xmlns="com.autoesl.autopilot.project" name="EMB2_Image_processor" top="image_processing">
    ...
    <files xmlns="">
        <file name="../../main_test_bench.cpp" sc="0" tb="1" cflags=" -Wno-unknown-pragmas" csimflags=" -Wno-unknown-pragmas" blackbox="false"/>
        <file name="main.cpp" sc="0" tb="false" cflags="" csimflags="" blackbox="false"/>
    </files>
    <solutions xmlns="">
        <solution name="Image_Processor" status="active"/>
    </solutions>
</project>
