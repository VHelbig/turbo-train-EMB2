...
HLS_SOURCES = ../../../../main_test_bench.cpp ../../../../main.cpp
...
$(ObjDir)/main_test_bench.o: ../../../../main_test_bench.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../main_test_bench.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/main_test_bench.d
