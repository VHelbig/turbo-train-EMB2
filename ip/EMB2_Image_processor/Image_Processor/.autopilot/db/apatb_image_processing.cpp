...
// wrapc file define:
#define AUTOTB_TVIN_gmem "../tv/cdatafile/c.image_processing.autotvin_gmem.dat"
#define AUTOTB_TVOUT_gmem "../tv/cdatafile/c.image_processing.autotvout_gmem.dat"
// wrapc file define:
...
// tvout file define:
#define AUTOTB_TVOUT_PC_gmem "../tv/rtldatafile/rtl.image_processing.autotvout_gmem.dat"
// tvout file define:
    ...
    string AESL_num;{
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<32> > gmem_pc_buffer(6000);
          int i = 0;
...
sc_bv<32> __xlx_tmp_lv = ((int*)__xlx_apatb_param_out)[j];
  ...
  tcl_file.set_num(6000, &tcl_file.gmem_depth);
