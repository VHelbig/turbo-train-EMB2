...
extern "C" void image_processing(int*, int, int);
extern "C" void apatb_image_processing_hw(volatile void * __xlx_apatb_param_in, volatile void * __xlx_apatb_param_out) {
  ...
  int __xlx_size_param_in = 3000;
  int __xlx_offset_param_in = 0;
  int __xlx_offset_byte_param_in = 0*4;
  for (int j = 0, e = 3000; j != e; ++j) {
    __xlx_in_out__tmp_vec.push_back(((int*)__xlx_apatb_param_out)[j]);
  }
  int __xlx_size_param_out = 3000;
  int __xlx_offset_param_out = 3000;
  int __xlx_offset_byte_param_out = 3000*4;
